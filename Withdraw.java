...
public class Withdraw extends JFrame implements ActionListener{
    ...
    { 
        ...
        title = new JLabel("Withdraw amount"); 
        ...
        if (e.getSource() == sub) { 
                try{  
                 ...
                 String accn = tmno.getText();
                  ...
                  int wh = Integer.parseInt(am.getText());
                  bal = bal - wh ;
                  if(bal<0) {label.setText("Sorry, insufficient funds..");}
                  else
