...
public class DeleteAc extends JFrame implements ActionListener{
    private Container c; 
    ...
    { 
        ...
        title = new JLabel("Delete an account"); 
        ...
        if (e.getSource() == sub) { 
                try{  
                 ...
                 label.setText("");
                  ...
                  PreparedStatement stmtp2=con.prepareStatement("delete from banktable where accno = ?");
                  stmtp2.setString(1,accn);  
